const defaultState = {
  ...
  categoriesEN: ["sizes", "breads", "vegetables", "sauces", "fillings", "ready"],
...
export const counterReducer = (state = defaultState, action) => {
  switch (action.type) {
    ...
    case "DELETE_PRODUCT_BUCKET":
      ...
      return {
        ...state,
        ordersArray: state.ordersArray.filter((order) => order.id !== action.payload),
      };
...
export const modalIngredientsBD = (payload) => ({ type: "GET_INGREDIENTS_BD", payload });
...
export const foundProducts = (payload) => ({
  type: "FOUND_PRODUCTS",
  payload,
});
